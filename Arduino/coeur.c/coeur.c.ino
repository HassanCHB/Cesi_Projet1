...
int menu() {
    ...
    Serial.print("Menu:\n");
    Serial.print("1:Clignottement\n");
    Serial.print("2:Chenillard\n");
    Serial.print("3:Affichage progressif\n");
    Serial.print("4:Affichage 1 sur 2\n");
    Serial.print("5:Affichage 1 sur 3\n");
    Serial.print("6:Affichage 1 sur 4\n");
    Serial.print("7:Affichage 1 sur 5\n");
    Serial.print("8:Affichage 1 sur 10\n");
